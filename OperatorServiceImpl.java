...
import com.company.onlinecustomerservicecenter.department.DepartmentRepo;
...
public class OperatorServiceImpl implements OperatorService {
    ...
    public Operator issueSolved(Integer opertaorId, Integer issueId)throws OperatorException {
        ...
        Operator operator=operatorOpt.get();
        Issue issue=issueOpt.get();
       if(!operator.getIssueBucket().getIssues().contains(issue))
          throw new OperatorException("There is no such issue assigned to the operator");
